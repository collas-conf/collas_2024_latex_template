...
\section{Submission of conference papers to CoLLAs 2024}
...
Papers to be submitted to CoLLAs 2024 must be prepared according to the
...
\end{center}
The file \verb+collas2024_conference.pdf+ contains these
instructions and illustrates the
various formatting requirements your CoLLAs paper must satisfy.
Submissions must be made using \LaTeX{} and the style files
\verb+collas2024_conference.sty+ and \verb+collas2024_conference.bst+ (to be used with \LaTeX{}2e). The file
\verb+collas2024_conference.tex+ may be used as a ``shell'' for writing your paper. All you
